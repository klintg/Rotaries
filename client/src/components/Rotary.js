...
export default class Rotary extends PureComponent {
  render() {
    const { _id, i, name, description, picture, toggleModal, deleteCar} = this.props;
    return (
        ...
        <div className="thumbnail">
          ...
          <div className="caption">
            ...
            <div className="btn-group" role="group" aria-label="...">
              ...
              <button className="btn btn-danger" role="button" onClick={() => deleteCar(_id)}>Delete</button>
            </div>
          </div>
        </div>
      </div>
